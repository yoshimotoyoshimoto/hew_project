                            ...
                            <fieldset>
                                ...
                                <form action="./login.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="mail" value="<?php if(isset($_SESSION['mail'])){ echo $_SESSION['mail']; unset($_SESSION['mail']); }?>">
                                   ...
                                   <button type="submit" class="btn btn-primary" name="login_check" value="login_check">ログイン</button>
