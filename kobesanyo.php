...
$json = 'https://www.train-guide.westjr.co.jp/api/v3/kobesanyo.json';
...
foreach($trains as $val){
    ...
    if($val['direction'] == '0'){
        ...
        $val['direction'] = '下り(姫路・上郡方面行き)';
    }elseif($val['direction'] == '2'){
        $val['direction'] = '上り(大阪方面行き：湖西線経由)';
    }
    //遅れ
...
require_once './tpl/kobesanyo.php';